...
def test_acceptance_walkin_rejection_and_boost():
    ...
    # FRESHER_ONLY_MODE now defaults to True, so descriptions need a fresher signal
    # to pass the gate at all — otherwise every walk-in scores 0 regardless of date.
